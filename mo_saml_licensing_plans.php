...
function mo_o365_saml_show_licensing_page(){
...
<?php
    $lp = get_site_option('mo_license_plan_from_feedback');
...
?>
<div style="text-align: center; font-size: 14px; background: forestgreen; color: white; padding-top: 4px; padding-bottom: 4px; border-radius: 16px;"><?php echo get_site_option('mo_saml_license_message'); ?></div>
    ...
    <div class="cd-pricing-container cd-has-margins"><br>
        <h1 style="font-size: 32px;">Choose Your Licensing Plan</h1>
                        ...
                        <ul class="cd-pricing-wrapper">
                            <li data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sseborder; ?>">
                                <a id="popover6" data-toggle="popover" title="<h3><?php _e('Why should I choose this plan?','miniorange-saml-20-single-sign-on');?></h3>" data-placement="top" data-html="true"
                                   data-content="<p><?php _e('Choose this plan if you are looking for ','miniorange-saml-20-single-sign-on');?><br /><b>
                               <?php _e('All exclusive features included','miniorange-saml-20-single-sign-on');?><br />
                               <?php _e('Add-ons (Page Restriction, BuddyPress Attribute Mapping, LearnDash Attribute Mapping, Media Restriction, Attribute based Redirection, Federation SSO, SCIM-User Provisioning, SSO Session Management, SSO Login Audit,).','miniorange-saml-20-single-sign-on');?></b><br />
                               <span style='color:red;'><b><?php _e('Note:','miniorange-saml-20-single-sign-on');?></b></span>
                                <?php _e('All the Add-ons are packaged with this plan. All features of all the Plans are included here.','miniorange-saml-20-single-sign-on');?></p>">
                                    <header class="cd-pricing-header">
                                        <h2 style="margin-bottom:10px;"><?php _e('All-Inclusive','miniorange-saml-20-single-sign-on');?></h2>
                                        <div style="height:90px;">
                                            <h3 class="subheading_plans" style="color:black; font-size: 16px;"><?php _e('All features along <br>with all Add-ons','miniorange-saml-20-single-sign-on');?></h3></div>
                                        <div class="cd-price" >
                                            <span class="cd-currency">$</span>
            ...
            <p>1. Click on 'Upgrade now' button of the required licensing plan. You will be redirected to miniOrange Login Console. Enter your password with which you created an account
                ...
                <h3><br>* Cost applicable for one instance only. Licenses are subscriptional and the Support Plan includes 12 months of maintenance (support and version updates). You can renew maintenance after 12 months at 50% of the current license cost.</h3>
            <br />
...
<?php
	echo '<form style="display:none;" id="licenseform" action="'.Mo_o365_options_plugin_constants::HOSTNAME.'/moas/login"
		target="_blank" method="post">
		<input type="email" name="username" value="'.get_site_option('mo_saml_admin_email').'" />
		<input type="text" name="redirectUrl" value="'.Mo_o365_options_plugin_constants::HOSTNAME.'/moas/initializepayment" /><input type="text" name="requestOrigin" id="requestOrigin2"  />
		</form>
