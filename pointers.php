...
if($tab == 'default')
{
    $pointers['default-miniorange-select-your-idp'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Select Office 365 as IDP (Step 1 of 12)' ) ),
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'Choose Office 365 as your IDP, and refer to the setup guide  for complete instructions.' ) ),
        'anchor_id' => '#select_your_idp',
        'isdefault' => 'yes',
        'edge'      => 'left',
        'align'     => 'left',
        'where'     => array( 'toplevel_page_mo_o365_saml_settings' )
    );
    $pointers['default-miniorange-sp-metadata-url'] = array(
        ...
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'Use this Metadata URL or file to configure Office 365.' ) ),
    ...
    $pointers['default-miniorange-upload-metadata'] = array(
        ...
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'Once you have configured Office 365, you can use this button to upload the metadata received from Office 365.' ) ),
    ...
    $pointers['default-miniorange-test-configuration'] = array(
        ...
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'After uploading the metadata from Office 365, use this button to test the configurations between Office 365 and WordPress.' ) ),
    ...
    $pointers['default-miniorange-addons3'] = array(
        ...
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'This add-on will map the attributes received from IdP to LearnDash user profile.' ) ),
...
if($tab == 'save'){
    ...
    if(mo_o365_saml_is_sp_configured() || get_option('saml_x509_certificate')){
