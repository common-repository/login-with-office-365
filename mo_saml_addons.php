<?php
function mo_o365_saml_show_addons_page(){
    ...
    <div id="miniorange-addons" style="position:relative;z-index: 1">
        ...
        <?php
        foreach(mo_o365_options_addons::$RECOMMENDED_ADDONS_PATH as $key => $value){
            if (is_plugin_active($value)) {
                $addon = $key;
                $addons_displayed[$addon] = $addon;
                echo mo_o365_get_addon_tile($addon, mo_o365_options_addons::$ADDON_TITLE[$addon],$addon_desc[$addon], mo_o365_options_addons::$ADDON_URL[$addon], true);
            }
        }
        ...
        foreach ($addon_desc as $key => $value) {
            if(!in_array($key, $addons_displayed))
                echo mo_o365_get_addon_tile($key, mo_o365_options_addons::$ADDON_TITLE[$key],$value, mo_o365_options_addons::$ADDON_URL[$key], false);
        }
        ?>
    </div> <?php
}

function mo_o365_get_addon_tile($addon_name, $addon_title, $addon_desc, $addon_url, $active){
...
function mo_o365_saml_show_integrations_page()
{?>
    <div style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 2% 0px 2%;">
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Enable User synchronization (SCIM, WP Cron, MS Graph) <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Enable Microsoft 365 profile picture mapping as WP avatar <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Enable Microsoft 365 / Azure AD profile fields sync <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>    
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Multi-tenant/ extranet login / Login through microsoft services <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Send email using Microsoft Graph <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Embed Microsoft Power BI content <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4> 
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Embed Sharepoint / One drive / delve folders in WordPress page <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Adding a WordPress tab to Microsoft Teams and use Single Sign-on <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    <hr>
    <h4><label class="switch"><input type="checkbox" name="profile_sync" disabled><span class="slider round"></span></label>
    &nbsp;Search Sharepoint people / results by query <sup style="font-size: 11px;color:#1e55d2"> <i class="fa fa-lock" aria-hidden="true" style="color:black"></i> [Please contact us via Support form to unlock this Premium feature]</sup></h4>
    </div>
<?php
} 
?>